...
function sumAndValidation(num1, num2) {
    if (typeof num1 !== 'number') {
        alert('-Excercises 6.d. The values are not number, please enter a number: ' + num1)
        return NaN;
    ...
    if (typeof num2 !== 'number'){
        alert('-Excercises 6.d. The values are not number, please enter a number: ' + num2);
        return NaN;
...
console.log('The result with rounded value is: ' + sumAndValidation(4.6, 5) );
...
console.log('The result of exercise 6.e is: ' + sum1(2.7, 13));
